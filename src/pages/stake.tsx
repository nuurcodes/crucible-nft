...
import { Emoji, StakeButton } from "../components/shared";
  ...
  if (!onboard || !notify) {
    ...
    return (
      <Flex direction="column" minH="100vh">
        ...
        <div>
          Ether Balance: {balance ? balance / 1000000000000000000 + " ETH" : ""}
        </div>
        <div>
          Staking Token Balance:{" "}
          {stakingTokenBalance
            ? stakingTokenBalance / 1000000000000000000 + " TOKENS"
            : ""}
        </div>
        <div>
          LP Token Balance:{" "}
          {lpTokenTokenBalance
            ? lpTokenTokenBalance / 1000000000000000000 + " TOKENS"
            : ""}
        </div>
